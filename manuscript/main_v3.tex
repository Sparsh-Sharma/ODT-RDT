...
\begin{figure}
  ...
  the size cap at matched rate preserves it, and the $4\times$ rate
  reduces it in proportion. Medians
...
\begin{table}
  ...
  C5.2 & size-capped $\ell\le\ell^*$, adaptive depth inside --- the clock-relaxed ODT\\[2pt]
  \hline
  \end{tabular}
