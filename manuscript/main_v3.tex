...
\begin{figure}
  ...
  dotted/$\triangle$); the hatched band is the DNS $b_{11}$ range over
  slow-to-fast $S^{*}$. The strained components $b_{22}$ and $b_{33}$
  are reproduced quantitatively; the unstrained $b_{11}$ is
