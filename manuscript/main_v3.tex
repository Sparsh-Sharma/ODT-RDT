...
The paper reports six results the following aspects of model formulation and assessment:
\begin{itemize}
...
\item Validation against the strained-turbulence experiment of \citet{ChenMeneveauKatz2006}~(CMK), summarized in (\S\,\ref{sec:cmk}) Sec. 4.5 with details provided in
...
\begin{table}
  ...
  the intervention categories. Measured fine-scale effects and readings
