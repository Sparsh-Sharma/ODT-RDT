...
blocking correction with which it must ultimately be combined. A
complete prediction---blocking, strain history, spanwise coherence and
absolute levels---requires the acoustic stage proper, for which the
present model supplies the missing input at negligible cost, with its
