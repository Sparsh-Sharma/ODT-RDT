...
\begin{figure}
  ...
  $E(\kappa_2)$: SC-ODT (strain on) extends to higher wavenumber
...
large scales by the nonlinear return. SC-ODT distributes
...
\begin{figure}
  ...
  state; SC-ODT ($1024$ realisations) against exact projected
