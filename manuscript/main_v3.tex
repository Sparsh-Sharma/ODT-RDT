...
size-capped clock holds the fine scales at every strain with no
...
strain-coupled model, and the model under each of the two mechanism
...
\begin{figure}
  ...
  strain-coupled model, and the model with each mechanism form
  (adaptive depth; size-capped relaxation clock), at
...
\begin{figure}
  ...
  $e=0.5$--$2$: (\textit{a}) $Sk_t/\varepsilon\approx0.4$,
...
\begin{figure}
  ...
  physical-unit bridge. Solid: the same chain with the computed
  distorted inflow at total strains $e=0.5$, $1$ and $2$
