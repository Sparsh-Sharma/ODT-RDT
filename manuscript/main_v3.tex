...
simulations of the same deformations at moderate Reynolds number
\citep{ZusiPerot2013,ZusiPerot2014}, and of the
\citeauthor{ChenMeneveauKatz2006} straining cycle
\citep{GualtieriMeneveau2010}, provide independent journal-published
comparators.
%% TODO(O8, pending PDFs): overlay ZusiPerot2013 on fig_LR_plane,
%% ZusiPerot2014 on a revived fig_LR_axisym, GualtieriMeneveau2010 in
%% ESM S1; then extend the sentence above to point at those figures.
The
