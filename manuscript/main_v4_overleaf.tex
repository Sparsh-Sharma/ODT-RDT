...
u_j(y,t_0)$, so continuous profiles map
...
spectral closure---the LRR closure of \S\,\ref{sec:verification}, with
the isotropic form \eqref{eq:iso-B} its onset limit---while dilating the domain
