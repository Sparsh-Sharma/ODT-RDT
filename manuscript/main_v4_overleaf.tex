...
\item The measured limits of the model and a mechanism that moves them
...
$\mathcal{A}_{ij}\equiv-A_{ij}+B_{ij}$ acts pointwise---the
non-diffusive sub-step solution
$u_i(y,t)=[\exp\!\int_{t_0}^{t}\mathcal{A}\,\mathrm{d}t']_{ij}\,
u_j(y,t_0)$ is a $y$-independent matrix---so continuous profiles map
