...
propagation are resolved within a single framework. The simulation of
grid-generated turbulence by lattice Boltzmann methods has been validated
against classical wind-tunnel data by \citet{Djenidi2006}, and the present
configuration follows recent LBM studies of grid-turbulence interaction
with airfoils \citep{Trascinelli2023,Piccolo2024}.
